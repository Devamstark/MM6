        ...
        <div className="space-y-8 animate-fade-in">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    ...
                    <p className="text-gray-500 font-medium">Control administrative access and seller permissions.</p>
                </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                {filteredStaff.map((member, idx) => (
                    <div
                        key={member.id}
                        className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 group animate-fade-up relative overflow-hidden"
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start">
                            ...
                            <div className="relative">
                                <div className="w-24 h-24 rounded-[2rem] bg-indigo-50 flex items-center justify-center text-indigo-600 overflow-hidden border-4 border-white shadow-inner">
                            ...
                            <div className="flex-grow space-y-4 text-center sm:text-left w-full">
                                <div className="flex justify-between items-start">
                                    ...
                                    <button className="text-gray-300 hover:text-indigo-600 transition-colors p-2 sm:block hidden">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                                    <div className="flex items-center gap-3 text-gray-500 group-hover:text-gray-900 transition-colors">
                                        ...
                                        <span className="text-xs font-bold truncate max-w-[150px]">{member.email}</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-gray-500 group-hover:text-gray-900 transition-colors">
                                        <div className="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center">
                                ...
                                <div className="flex flex-col sm:flex-row justify-between items-center pt-6 sm:pt-4">
            ...
            <div className="bg-indigo-600 rounded-[3rem] p-12 relative overflow-hidden group shadow-2xl shadow-indigo-200">
                {/* Abstract patterns */}
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <button className="bg-white text-indigo-600 px-10 py-5 rounded-[2rem] font-black text-xs uppercase tracking-[0.2em] hover:scale-105 active:scale-95 transition-all shadow-2xl flex items-center gap-3">
