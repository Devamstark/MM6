    ...
    return (
        <div className="space-y-8 animate-fade-in">
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-3xl font-black text-gray-900 tracking-tight">Promo Coupons</h2>
            ...
            {isAdding && (
                <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-xl animate-scale-in">
                    <form onSubmit={handleCreate} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-gray-50 border-none rounded-2xl p-4 text-sm font-bold focus:ring-2 focus:ring-indigo-500 transition-all uppercase"
                        ...
                        <div className="flex items-end">
                            <button
                                type="submit"
                                className="w-full bg-gray-900 text-white p-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-gray-800 transition-all shadow-lg shadow-gray-200"
                            >
                                Save Coupon
                            </button>
                        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {coupons.map((coupon, idx) => (
                    <div
                        key={coupon.id}
                        className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 group relative overflow-hidden animate-fade-up"
                    ...
                    >
                        ...
                        <div className="relative space-y-4">
                            <div>
                                <h3 className="text-2xl font-black text-gray-900 tracking-tight">{coupon.code}</h3>
                            ...
                            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-50">
                                <div className="space-y-1">
                                    <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Min. Spend</p>
                                    <p className="text-sm font-bold text-gray-900">${coupon.min_purchase}</p>
                                </div>
                                <div className="space-y-1">
                                    <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Usage</p>
                                    <p className="text-sm font-bold text-gray-900">{coupon.used_count} / {coupon.usage_limit || '∞'}</p>
                                </div>
                            </div>
                ...
                {coupons.length === 0 && !isAdding && (
                    <div className="col-span-full border-2 border-dashed border-gray-100 rounded-[2.5rem] p-20 flex flex-col items-center justify-center text-center">
